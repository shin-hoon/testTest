...
public class MainPanel{
	...
	public void searchList() {
		...
		JLabel category = new JLabel("검색결과");
		...
		for(int i = searchList.size()-1 ; i >= 0; i--) {
				...
				mainImage.addMouseListener(new MainMouseEvent(searchList.get(i),"상세페이지"));
				...
				price = new JLabel(comma.format(searchList.get(i).getPrice())+"원" );
